...
export default function DashboardScreenModern() {
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View className="px-6 py-6 gap-4">
          ...
          <View className="mt-4 gap-3">
            ...
            <Pressable
              onPress={() => console.log("Navigate to walk tracker")}
              className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-4 flex-row items-center justify-between"
            >
            ...
            <Pressable
              onPress={() => console.log("Navigate to lost pet QR")}
              className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl p-4 flex-row items-center justify-between"
            >
