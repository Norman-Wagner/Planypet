...
const sections = [
  { title: "1. Geltungsbereich", content: "Diese Allgemeinen Geschaeftsbedingungen (AGB) gelten fuer die Nutzung der mobilen Anwendung \"Planypet\" (nachfolgend \"App\" genannt), die von der Wagnerconnect UG (haftungsbeschraenkt) (nachfolgend \"Anbieter\" genannt), bereitgestellt wird. Mit der Installation und Nutzung der App erklaeren Sie sich mit diesen AGB einverstanden." },
